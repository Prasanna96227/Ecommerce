...
<c:if test="${pageContext.request.userPrincipal.name  != 'admin'}">
    <form:form action="/shoppingwebsite/updateshopitem" method="post"
               modelAttribute="usitem" enctype="multipart/form-data">
        <form:hidden path="itemsId" value="${usitem.itemsId}" />

        <div class="form-group row">
            <label for="itemn" class="col-sm-2 col-form-label">Item Name</label>
            <div class="col-sm-10">
                <form:input path="iName" id="itemn" class="form-Control" value="${usitem.iName}"/>
            </div>
        </div>

        <form:input type="hidden" path="typeofperson" id="type" value = "${usitem.typeofperson}"/>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <form:select path = "iTypeOfProduct" cssClass="btn btn-default">
                    <form:option value = "${usitem.iTypeOfProduct}" label = "Select" id="type" />
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <form:input path="iInformation" value="${usitem.iInformation}" id="info" class="form-Control"/>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <form:input path="iPrice" id="cost" value="${usitem.iPrice}" class="form-Control"/>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <form:input path="itemAvailable" value="${usitem.itemAvailable}" id="i" class="form-Control"/>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <form:input path="iBrand" value="${usitem.iBrand}" id="brand" class="form-Control"/>
            </div>
        </div>
