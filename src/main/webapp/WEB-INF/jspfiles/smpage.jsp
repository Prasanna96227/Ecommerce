...
<div class="container">
    ...
    <h1 align="center"> ShopManager page</h1>
    <br><br><br><br>


        <h4>
            <a href="<c:url value="/shop/itemmodifications/${pageContext.request.userPrincipal.name}" />" class="btn btn-default">Item Modifications</a>
        </h4>

        <br>

        <h4>
            <a href="<c:url value="/shop/customer/${pageContext.request.userPrincipal.name}" />"  class="btn btn-default">Users list</a>
        </h4>
