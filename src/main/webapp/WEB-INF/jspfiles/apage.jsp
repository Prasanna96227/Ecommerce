...
<div class="container" >
    ...
    <br><br><br> <br>
        ...
        <h4>
            <a href="<c:url value="/itemmodifications" />" class="btn btn-default">Item Modifications</a>
        </h4>

        <br>

        <h4>
              <a href="<c:url value="/shoplist" />" class="btn btn-default">Shop Managers having products</a>
        </h4>
    <br>
    <h4>
        <a href="<c:url value="/smreg" />" class="btn btn-default">Registered Shop Managers</a>
    </h4>
    <br>

    <h4>
        <a href="<c:url value="/uapage/${pageContext.request.userPrincipal.name}" />" class="btn btn-default">Users bought admin products</a>
    </h4>
    <br>

        <h4>
            <a href="<c:url value="/consumerlist" />" class="btn btn-default">Registered Users</a>
        </h4>
