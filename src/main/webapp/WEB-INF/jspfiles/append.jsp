...
<div class="container">
       ...
       <h2>Add item</h2>
        ...
        <form:form action="/shoppingwebsite/append" method="post"  modelAttribute="item" enctype="multipart/form-data">
        ...
        <a href="<c:url value="/itemmodifications" />" class="btn btn-primary">Cancel</a>
        </form:form>
