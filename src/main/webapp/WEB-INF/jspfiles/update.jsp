...
<div class="container">
    <h2>Update item</h2>
        ...
        <form:form action="/shoppingwebsite/update" method="post"
                   modelAttribute="uitem" enctype="multipart/form-data">
            <form:hidden path="itemsId" value="${uitem.itemsId}" />

        <div class="form-group row">
            <label for="itemn" class="col-sm-2 col-form-label">Item Name</label>
            <div class="col-sm-10">
                <form:input path="iName" id="itemn" class="form-Control" value="${uitem.iName}"/>
            </div>
        </div>

            <form:input type="hidden" path="typeofperson" id="type" value = "${uitem.typeofperson}"/>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <form:select path = "iTypeOfProduct" cssClass="btn btn-default">
                    <form:option value = "${uitem.iTypeOfProduct}" label = "Select" id="type" />
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <form:input path="iInformation" value="${uitem.iInformation}" id="info" class="form-Control"/>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <form:input path="iPrice" id="cost" value="${uitem.iPrice}" class="form-Control"/>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <form:input path="itemAvailable" value="${uitem.itemAvailable}" id="i" class="form-Control"/>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <form:input path="iBrand" value="${uitem.iBrand}" id="brand" class="form-Control"/>
            </div>
        </div>
        ...
        <a href="<c:url value="/itemmodifications" />" class="btn btn-default">Cancel</a>
        </form:form>
